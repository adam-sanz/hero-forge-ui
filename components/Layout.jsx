...
import { FaFileContract, FaGithub, FaLinkedin, FaWallet } from "react-icons/fa";
import {
  Flex,
  Icon,
  IconButton,
    ...
    >
      ...
      <Flex align={"center"} justify={"space-between"} w={"100%"} p={5} px={20}>
        <Flex w={"50%"}>
          ...
          <Tooltip hasArrow label={"Contract"} bg={"gray.900"} color={"white"}>
            <IconButton
              ...
              isExternal
              icon={<Icon as={FaFileContract} w={7} h={7} />}
            />
          </Tooltip>
          <Tooltip hasArrow label={"github"} bg={"gray.900"} color={"white"}>
            <IconButton
              ...
              as={Link}
              href={"https://github.com/adam-sanz/hero-forge-ui"}
              isExternal
        ...
        >
          <Text>
            {chain ? (
              <Text color={"blue.600"}>Connected to Mumbai</Text>
            ) : (
